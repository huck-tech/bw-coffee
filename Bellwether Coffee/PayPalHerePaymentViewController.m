...
#import "PayPalHerePaymentViewController.h"
//#import "PaymentCompleteViewController.h"
//#import "AppDelegate.h"

@interface PayPalHerePaymentViewController ()<
...
@property (nonatomic) PPHCardReaderWatcher *cardReaderWatcher;
@property (nonatomic) PPHTransactionWatcher *transactionWatcher;
@property (nonatomic) PPHInvoice *invoice;

@property (nonatomic) BOOL promptedForSoftwareUpdate;
@property (nonatomic) UIAlertView *softwareUpgradeAlert;

@end

@implementation PayPalHerePaymentViewController
...
//    [self.view addSubview:enterAmountLabel];
    ...
    [PayPalHereSDK activeMerchant].currencyCode = @"USD";
...
- (void)viewDidAppear:(BOOL)animated {
    ...
    [self billCustomer:self.tipPrice];
}
...
- (void)gotoPaymentCompleteScreenWithResponse:(PPHTransactionResponse *)response {
    ...
    NSLog(@"gotoPaymentCompleteScreenWithResponse");
    printf("Completed");
    
    [self.navigationController dismissViewControllerAnimated:true completion:^{
        [_delegate paymentDidComplete];
    }];
...
// for SCA in case of unreliable connection
...
- (void)billCustomer:(NSString *)price
{
    [self.invoice removeAllItems];
    ...
    if (price.length) {
        [self.invoice addItemWithId:@"TTF"
                           detailId:nil
                               name:[NSString stringWithFormat:@"Tip The Farmer - Grower: %@", _trackingInfo]
                           quantity:[NSDecimalNumber one]
                          unitPrice:[NSDecimalNumber decimalNumberWithString:price]
                            taxRate:nil
                        taxRateName:nil];
    }
