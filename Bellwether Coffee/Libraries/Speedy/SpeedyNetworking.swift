...
class SpeedyNetworking {
    ...
    class func setAppUrl(url: URL?) {
        SpeedyConfiguration.shared.defaultAppUrl = url
    }
...
extension SpeedyNetworking {
    ...
    class func post<T: Encodable>(route: String, model: T, data: Any? = nil, completion: @escaping (SpeedyResponse) -> Void) {
    ...
    class func postUrl<T: Encodable>(url: URL?, model: T, data: Any? = nil, completion: @escaping (SpeedyResponse) -> Void) {
        let params = SpeedyParams(model: model)
...
extension SpeedyNetworking {
    ...
    class func put<T: Encodable>(route: String, model: T, data: [String: Any]? = nil, completion: @escaping (SpeedyResponse) -> Void) {
        let params = SpeedyParams(model: model, data: data)
    ...
    class func putUrl<T: Encodable>(url: URL?, model: T, data: [String: Any]? = nil, completion: @escaping (SpeedyResponse) -> Void) {
        let params = SpeedyParams(model: model, data: data)
...
extension SpeedyNetworking {
    ...
    class func downloadImage(path: String, completion: @escaping (UIImage?) -> Void) {
        let imageUrl = SpeedyConfiguration.shared.defaultAppUrl?.appendingPathComponent(path)
        SpeedyDownload(url: imageUrl)?.executeImage(completion: completion)
    }
