...
class SelectPaymentCardCell: CollectionViewCell {
    ...
    override func updateCellData() {
        guard let paymentMethod = cellData as? PaymentMethod else { return }
        
        cardType.text = paymentMethod.type
        cardNumber.text = "•••• •••• •••• \(paymentMethod.description ?? "")"
